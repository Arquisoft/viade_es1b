(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@shexjs/parser'), require('@shexjs/core'), require('solid-auth-client'), require('@solid/query-ldflex'), require('uuid'), require('moment'), require('@rdfjs/data-model')) :
    typeof define === 'function' && define.amd ? define(['exports', '@shexjs/parser', '@shexjs/core', 'solid-auth-client', '@solid/query-ldflex', 'uuid', 'moment', '@rdfjs/data-model'], factory) :
    (global = global || self, factory(global.solidForms = {}, global.shexParser, global.shexCore, global.auth, global.data, global.uuid, global.moment, global.dataModel));
}(this, function (exports, shexParser, shexCore, auth, data, uuid, moment, dataModel) { 'use strict';
    ...
    ***************************************************************************** */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, data.from(updatedProperty)[field][property]];
                    case 1:
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 9:
                        ...
                        return [4 /*yield*/, turtleToFormUi(data[field])];
                    case 10:
                    ...
                    case 20:
                        if (!(!fields[subjectPrefix_1][UI.LABEL] &&
                            ...
                            fields[subjectPrefix_1][UI.PROPERTY])) return [3 /*break*/, 22];
    ...
    function getClonePart(childs) {
        var _a;
        return __assign({}, childs, (_a = {}, _a[UI.CLONE_PARTS] = childs[UI.PARTS], _a));
    }
    /**
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 1:
                        ...
                        _q.label = 2;
                    case 2:
                        parts = modelUi[UI.PARTS];
                        fields = Object.keys(modelUi[UI.PARTS]);
                        newModelUi = modelUi;
                        _q.label = 3;
                    case 3:
                    ...
                    case 30:
                        ...
                        parentPro = parentProperty && parentUri
                            ? (_j = {}, _j[UI.PARENT_PROPERTY] = parentProperty, _j[UI.BASE] = parentUri, _j) : {};
                        _h = [{}, parentPro, (_k = {}, _k[UI.REFERENCE] = fieldValue, _k)];
                    ...
                    case 32:
                        objectValue = parentValue && !isMultiple
                            ? (_l = {},
                                _l[UI.VALUE] = parentValue,
                                _l[UI.OLDVALUE] = parentValue,
                                _l[UI.NAME] = uuid(),
                                _l[UI.BASE] = podUri,
                                _l[UI.VALID] = true,
                                _l) : (_m = {}, _m[UI.NAME] = uuid(), _m[UI.BASE] = podUri, _m[UI.VALID] = true, _m);
                        ...
                        updatedField = isGroup
                            ...
                            : (_o = {},
                                ...
                                _o);
                        newModelUi = __assign({}, newModelUi, (_p = {}, _p[UI.PARTS] = __assign({}, newModelUi[UI.PARTS], updatedField), _p));
                        _q.label = 33;
    ...
    function convertFormModel(documentUri, documentPod) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, turtleToFormUi(data[documentUri])];
                    case 1:
                        model = _b.sent();
                        modelUi = (_a = {
                    ...
                    case 4:
                        ...
                        for (quad in quads) {
                            ...
                            if ((!deprecated || deprecated.includes('false')) &&
                                ...
                                options = options.concat([getLabel(label)]);
                            }
                        }
                ...
                if (currentShape && currentShape.expression && currentShape.expression.expressions) {
                    currentShape.expression.expressions.forEach(function (te, i) {
                        ...
                        if (valueExpr.type === 'Shape') {
                             ...
                             */
                            var groupParts = new ListObject("#" + fieldTerm.id, namedNode_1(NS_UI + "parts"), graph_1, _this.termFactory);
    ...
    var FormActions = /** @class */ (function () {
        function FormActions(formModel, formObject) {
            ...
            this.saveData = function (customFormObject) { return __awaiter(_this, void 0, void 0, function () {
                var keyFields, keyFields_1, keyFields_1_1, key, currentField, validatedField, isType, predicate, value, podData, updatedValue, parent_1, e_1_1;
                var e_1, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                        ...
                        case 3:
                            ...
                            updatedValue = typeof value === 'boolean' ? value.toString() : value;
                        ...
                        case 9:
                            ...
                            if (!currentField[UI.OLDVALUE]) return [3 /*break*/, 11];
                            return [4 /*yield*/, podData.set(updatedValue)];
                        case 10:
                            _b.sent();
                            return [3 /*break*/, 13];
                        case 11: return [4 /*yield*/, podData.add(updatedValue)];
                        case 12:
                            _b.sent();
                            _b.label = 13;
                        case 13: return [3 /*break*/, 15];
                        case 14: throw new Error('Validation failed');
                        case 15:
                            /**
                             * Update ui:value and  ui:oldValue on formModel and reset formObject
                             */
                            this.updateFieldModel(validatedField[UI.NAME], isType ? validatedField[UI.VALUE] : validatedField.value, validatedField[UI.VALID], validatedField[UI.DEFAULT_ERROR]);
                            _b.label = 16;
                        ...
                        case 19:
                            ...
                            if (!(keyFields_1_1 && !keyFields_1_1.done && (_a = keyFields_1.return))) return [3 /*break*/, 21];
             ...
             */
            this.updateFieldModel = function (name, newValue, valid, errorMessage) {
                var _a;
                if (valid === void 0) { valid = true; }
                var partsObject = _this.formModel[UI.PARTS];
                var found = false;
                function findRecursive(name, value, model) {
                    var _a, _b, _c, _d;
                    for (var fieldKey in model) {
                        if (model[fieldKey][UI.NAME] === name) {
                            model = __assign({}, model, (_a = {}, _a[fieldKey] = __assign({}, model[fieldKey], (_b = {}, _b[UI.VALUE] = newValue, _b[UI.OLDVALUE] = newValue !== '' ? newValue : model[fieldKey][UI.OLDVALUE], _b[UI.VALID] = valid, _b[UI.DEFAULT_ERROR] = errorMessage, _b)), _a));
                            found = true;
                            break;
                        }
                        else if (model[fieldKey][UI.PARTS]) {
                            model = __assign({}, model, (_c = {}, _c[fieldKey] = __assign({}, model[fieldKey], (_d = {}, _d[UI.PARTS] = __assign({}, findRecursive(name, value, model[fieldKey][UI.PARTS])), _d)), _c));
                            if (found) {
                                break;
                            }
                        }
                ...
                try {
                    var updatedModel = findRecursive(name, newValue, partsObject);
                    /**
                     * Update private formModel store
                     */
                    _this.formModel = __assign({}, _this.formModel, (_a = {}, _a[UI.PARTS] = __assign({}, updatedModel), _a));
                    return _this.formModel;
                }
                catch (error) {
                    return Error(error);
                }
            ...
            this.deleteField = function (field) { return __awaiter(_this, void 0, void 0, function () {
                function deleteRecursive(field, model) {
                    var e_2, _a;
                    return __awaiter(this, void 0, void 0, function () {
                        var modelKeys, modelKeys_1, modelKeys_1_1, fieldKey, _b, value, withoutProperty, _c, _d, _e, _f, _g, e_2_1, error_2;
                        var _h, _j;
                        return __generator(this, function (_k) {
                            switch (_k.label) {
                                ...
                                case 3:
                                    if (!(modelKeys_1_1 = _k.sent(), !modelKeys_1_1.done)) return [3 /*break*/, 8];
                                    fieldKey = modelKeys_1_1.value;
                                    if (!(model[fieldKey][UI.NAME] === field)) return [3 /*break*/, 5];
                                    return [4 /*yield*/, FormActions.deleteFieldPod(model[fieldKey])];
                                case 4:
                                    _k.sent();
                                    _b = fieldKey, value = model[_b], withoutProperty = __rest(model, [typeof _b === "symbol" ? _b : _b + ""]);
                                    model = withoutProperty;
                                    found = true;
                                    return [3 /*break*/, 8];
                                case 5:
                                    if (!model[fieldKey][UI.PARTS]) return [3 /*break*/, 7];
                                    _c = [{}, model];
                                    _h = {};
                                    _d = fieldKey;
                                    _e = [{}, model[fieldKey]];
                                    ...
                                    _f = UI.PARTS;
                                    _g = [{}];
                                    return [4 /*yield*/, deleteRecursive(field, model[fieldKey][UI.PARTS])];
                                case 6:
                                    model = __assign.apply(void 0, _c.concat([(_h[_d] = __assign.apply(void 0, _e.concat([(_j[_f] = __assign.apply(void 0, _g.concat([(_k.sent())])), _j)])), _h)]));
                                    if (found) {
                                        return [3 /*break*/, 8];
                                    }
                                    _k.label = 7;
                                ...
                                case 10:
                                    ...
                                    if (!(modelKeys_1_1 && !modelKeys_1_1.done && (_a = modelKeys_1.return))) return [3 /*break*/, 12];
                ...
                function findField(nodeName, model) {
                    ...
                    for (var fieldKey in model) {
                        ...
                        if (currentField[UI.NAME] === nodeName && currentField['rdf:type'].includes('Multiple')) {
                            ...
                            var idLink = FormActions.getSubjectLinkId(currentField[UI.CLONE_PARTS][copiedField][UI.VALUE]);
                            var uniqueName = uuid();
                            model = __assign({}, model, (_a = {}, _a[fieldKey] = __assign({}, currentField, (_b = {}, _b[UI.PARTS] = __assign({}, currentField[UI.PARTS], (_c = {}, _c[uniqueName] = __assign({}, FormActions.cleanFieldNode(currentField[UI.CLONE_PARTS][copiedField]), (_d = {}, _d[UI.NAME] = uniqueName, _d[UI.VALUE] = idLink, _d)), _c)), _b)), _a));
                            found = true;
                            break;
                        }
                        else if (currentField[UI.PARTS]) {
                            model = __assign({}, model, (_e = {}, _e[fieldKey] = __assign({}, currentField, findField(nodeName, currentField[UI.PARTS])), _e));
                            if (found) {
                                break;
                            }
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, data[field[UI.BASE]][field[UI.PROPERTY]].delete(field[UI.VALUE])];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/];
