...
|Response Time| The notifications, storage, share features and POD management should take the least amount of time as possible (It depends on the internet speed, the amount of notifications you have and the routes and their images and videos.).
