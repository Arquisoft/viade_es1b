...
**Level 2**
In the second level we focus on the components block, because we believe that it is the most important, to differentiate between the five big parts of the web application. The other components blocks do not go into more detail because otherwise the documentation would be very extensive.
